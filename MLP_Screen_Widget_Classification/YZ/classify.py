...
class ScreenClassifierForAUT(object):
        ...
        if self.autoencoder:
            ...
            if app_name is not None:
                training_set = prepare_autoencoder_data_for_AUT(
                    "/Users/XXX/Documents/Research/UsageTesting/Final-Artifacts/embeddings/autoencoder/AllEmbeddingsOld",
                    "/Users/XXX/Documents/Research/UsageTesting/Final-Artifacts/embeddings/autoencoder/AllEmbeddings_augmented",
                    "/Users/XXX/Documents/Research/UsageTesting/Final-Artifacts/final_labels/final_labels_all.csv",
                    "/Users/XXX/Documents/Research/UsageTesting/Final-Artifacts/final_labels/augmented_annotations.csv",
    ...
    def classify(self, embedding_to_predict, AUT, N):
        # input_size = 4608
        self.clas = pickle.load(open(AUT + '_trained_MLP.pickle', 'rb'))
        self.classes = self.clas.classes_
...
if __name__ == "__main__":
    ...
    screen_classifier_autoencoder = ScreenClassifierForAUT(autoencoder=True)
    # print("Training with autoencoder:")
    # screen_classifier_autoencoder.learn('6pm')
    ...
    screen_classifier_autoencoder.classify(embedding_to_predict, 'etsy', 5)
    print('all done! :)')
