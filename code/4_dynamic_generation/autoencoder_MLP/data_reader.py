...
def get_image_path(filename):
    ...
    usage_root_dir = os.path.join(FINAL_ARTIFACT_ROOT_DIR, 'usage_data')
        # '/Users/XXX/Documents/Research/UsageTesting/Final-Artifacts/usage_data'
    augmented_data_dir = os.path.join(FINAL_ARTIFACT_ROOT_DIR, 'Screen_AugmentedTrainingData')
        # '/Users/XXX/Documents/Research/UsageTesting/Final-Artifacts/Screen_AugmentedTrainingData'
...
def prepare_autoencoder_data_for_AUT(embedding_file, augmented_embedding_file, final_label_file, augmented_label_file, AUT, remove_wrong_dimensions=False):
    ...
    # "/Users/XXX/Documents/Research/UsageTesting/Final-Artifacts/embeddings/autoencoder/AllNamesOld.json"
    all_names_augmented_path = os.path.join(FINAL_ARTIFACT_ROOT_DIR, 'embeddings', 'autoencoder', 'AllNames_augmented.json')
    # "/Users/XXX/Documents/Research/UsageTesting/Final-Artifacts/embeddings/autoencoder/AllNames_augmented.json"
